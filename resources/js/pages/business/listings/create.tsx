...
export default function CreateListing({ skills }: CreateListingProps) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        // Skills
        skills: [] as number[],
        custom_skills: [] as string[],
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('business.listings.store'));
    };
            ...
            <div className="container mx-auto px-6 py-8 pt-24">
                ...
                <div className="mb-6">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        Isi informasi lowongan dengan lengkap untuk mendapatkan pelamar yang sesuai dengan kebutuhan Anda.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="space-y-6">
                            ...
                            <Card className="shadow-md">
                                <CardContent>
                                    <h2 className="mb-4 text-lg font-semibold">Publikasikan Lowongan</h2>

                                    <div className="space-y-4">
                                        <p className="text-sm text-muted-foreground">
                                            Setelah Anda mempublikasikan lowongan, pelamar dapat melihat dan mengirimkan proposal untuk lowongan Anda.
                                        </p>
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <Button type="submit" disabled={processing}>
                                                {processing ? 'Memproses...' : 'Publikasikan Lowongan'}
                                            </Button>
                                        </div>
                                    </div>
                                </CardContent>
