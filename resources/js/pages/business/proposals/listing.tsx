...
import { ArrowLeftIcon, CheckCircleIcon, ChevronDownIcon, EyeIcon, FilterIcon, SendIcon, StarIcon, XCircleIcon } from 'lucide-react';
...
interface BusinessListingProposalsProps {
    listing: Listing;
...
export default function BusinessListingProposals({ listing, proposals, filters }: BusinessListingProposalsProps) {
    const handleFilterChange = (name: string, value: string) => {
        router.get(
            route('business.listings.proposals', { listing: listing.id }),
            {
                ...filters,
                [name]: value,
            },
    ...
    return (
        <AppLayout>
            <Head title={`Proposal untuk ${listing.title}`} />
            ...
            <div className="container mx-auto px-6 py-8 pt-24">
                ...
                <div className="mb-6">
                    <h1 className="text-2xl font-bold">Proposal untuk "{listing.title}"</h1>
                    <p className="mt-2 text-muted-foreground">{proposals.total} proposal diterima untuk lowongan ini</p>
                </div>
                        ...
                        <Card className="py-0 shadow-lg shadow-blue-900/5 dark:bg-neutral-900/50">
                            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                                ...
                                <p className="mt-2 max-w-md text-muted-foreground">
                                    Belum ada proposal yang diterima untuk lowongan ini. Tunggu beberapa saat lagi atau coba perbarui deskripsi
                                    lowongan untuk menarik lebih banyak pelamar.
                                </p>
                            </CardContent>
                        </Card>
                    ) : (
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex flex-wrap items-start justify-between gap-4">
                                            <div className="space-y-2">
                                                <h2 className="text-lg font-medium">{proposal.worker_profile?.user.name}</h2>
